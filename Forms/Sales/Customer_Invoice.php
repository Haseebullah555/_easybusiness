 ...
 <style>
            @page{
             ...
             font-family:Calibri;
                   ...
                   .uplabel{ text-align: right; font-family:Calibri; font-size: 16} 
        </style>
  </head>
  <body>
                            ...
                            <div class="p-sm-4 p-xl-7">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-4  font-size-sm ">
                                        ...
                                        if(Check_Get_Param($_GET['id'])== True){
                                           foreach($invoiceinfo as $cs1){
                                            ?>
                                        <label class="text-left">Name:  &nbsp;(
                                        <?php echo $cs1['Cus_name']; ?> )
                                        <br>
                                        Shop Name: &nbsp;( <?php echo $cs1['Shop_name'];?> )
                                        <br>
                                        Market Name: &nbsp;(  
                                        <?php echo $cs1['Market_name'];?> )
                                        <br>
                                        Phone No:  &nbsp;( 
                                        <?php echo $cs1['Phone'];?> ) <br>
                                        Address :&nbsp;(
                                        <?php echo $cs1['Address']; ?> )
                                ...
                                <img src="/UserUpload/downlogo.jpg" width="100%" height="200px" class="" />
                                <!-- END Footer -->
                            </div>
                        </div>
