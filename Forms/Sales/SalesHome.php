                                      ...
                                      <div class="col-xl-12">
                                          ...
                                          <div class="row mb-4">
                                              ...
                                              <div class="col-4 font-size-sm">
                                                  <table>
                                                      <tr>
                                                          <td> <input type="text" class="form-control form-control-sm input-sm col-4  " value="<?php echo $empid; ?>" readonly="" name="inv_id"></td>
                                                      </tr>
                                                      <tr>
                                                      ...
                                                      <tr>
                                                          <td> <label style="float:left" id="smallinput" class=" col-form-label">Gross Total : </label>
                                                              <input type="text" id="grosstotal" value="<?php foreach ($grosstotal as $gtt) {
                                                                                                            echo $gtt['total'];
                                                                                                        } ?>" class="form-control form-control-sm input-sm larginput " disabled="" name="grossTotal" style="background-color: #6e6b5e; color: yellow; font-weight: bold;">
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td> <label style="float:left" id="smallinput" class=" col-form-label">Discount : </label>
                                                              <input type="text" class="form-control form-control-sm input-sm larginput " value="" id="Discount" name="Discount" style="background-color: #6e6b5e;  color: red; font-weight: bold;">
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td> <label class=" col-form-label" style="float:left" id="smallinput"> Cash Due : </label>
                                                              <input type="text" class="form-control form-control-sm input-sm  larginput" id="CashDue" name="CashDue" style="background-color: #6e6b5e;  color: yellow; font-weight: bold;">
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td> <label style="float:left" id="smallinput" class=" col-form-label"> Recieved : </label>
                                                              <input type="text" class="form-control form-control-sm input-sm larginput " id="recieved" name="Receive" style="background-color: #6e6b5e;  color: yellow; font-weight: bold;">
                                                          </td>
                                              ...
                                              <table class="table table-vcenter table-borderless  nopadding " id="secondtbl">
                                                      <tr>
                                                          <td>
                                                          <!-- <select class="js-select2 form-control form-control-sm col-sm-6 " id="fcs"  style="float:left; margin-right: 5px; margin-bottom:5px; " name="searchbarcode" data-placeholder="انتخاب جنس">
                                                                  <option></option>
                                                                  <?php //foreach ($getstockitem as $cs1) { ?>
                                                                      <option value="<?php //echo $cs1['barcode']; ?>"><?php //echo $cs1['ProductName'].' '.$cs1['p_size']; ?></option>
                                                                  <?php // } ?>
                                                              </select> -->
                                                             <!-- <select class="js-select2 form-control form-control-sm col-sm-6 "
                                                              name="searchbarcode"  placeholder="بارکود" style="float:left; margin-right: 5px; " id="fcs" class=" form-control form-control-sm col-sm-6">
                                                              <?php // foreach ($getSalesItem as $br) {?>
                                                              <option value="<?php //echo $br['barcode']; ?>"><?php //echo $br['ProductName'].' '.$br['p_size']; ?></option>
                                                                  <?php  //} ?>
                                                              </select>  -->
                                                             
                                                             <input type="text" name="searchbarcode" value="<?php  foreach ($getSalesItem as $br) {
                                                                                                                    echo $br['barcode'];
                                                                                                                } ?>" placeholder="بارکود" style="float:left; margin-right: 5px; " id="fcs" class=" form-control form-control-sm col-sm-6" />
                                                              
                                                             
                                                             <input type="submit" name="searchItm" value="Srch" class="btn btn-sm btn-warning" /> 
                                                          </td>
                                              ...
                                              <div class="col-8 text-right font-size-sm table-responsive" style="width:100%; margin-top: -200px; margin-left: 400px; max-height:280px;">
                                                  ...
                                                  <table class="table table-vcenter  table-responsive  nofont ">
                                                      <thead>
                                                          ...
                                                          <tr>
                                                              <th>checked</th>
                                                              <th class="col-lg-8" style=" ">Item Desciption</th>
                                                              <th>Quantity</th>
                                                              <th>Price</th>
                                                              <th>Currency</th>
                                                              <th>Total</th>
                                              ...
                                              <div class="col-3 font-size-sm">
                                                  <table class="table table-borderless nopadding" id="toptable">
                                                      <tr>
                                                          <td><button type="submit" name="SavePrint" class="btn btn btn-outline-success">Save & Print</button>
                                                              <button class="btn btn btn-outline-info col-lg-5"><a href="/Sales/Invoice.php"><i class="fa fa-print"></i> Print</a></button>
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td><button class="btn btn btn-outline-warning">On Hold</button>
                                                              <button class="btn btn btn-outline-primary col-lg-3"> Refund</button>
                                                              <button class="btn btn btn-outline-danger col-lg-3" type="button" id="DiscountReceive" onclick="DiscountReceive();" name="PayAmount"> Pay</button>
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td><button class="btn btn btn-outline-danger col-lg-3"> Close </button>
                                                              <button class="btn btn btn-outline-dark col-lg-3" type="button" id="debtcash" name="debt_data" onclick="debtcash();">
                                                                  قرض </button>
                                                              <button type="submit" name="lastinvoice" class="btn btn btn-outline-warning">Last INV</button>
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td>
                                                              <button type="submit" name="deletetable" class="btn btn btn-outline-danger col-lg-10"> Delete Item</button>
                                                          </td>
                                                      </tr>
                                                  </table>
                                              </div>
